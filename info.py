...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5498521781').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003506134695'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002308128053 -1002370799287 -1003624430712').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002657262381 -1002545977673 -1002576686995') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002576686995')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002545977673')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003256554840').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filterauto0_db_user:Dhanu8996Bot123@sdmovieadda.soojroo.mongodb.net/filterauto0_db_user?retryWrites=true&w=majority&appName=SDmovieADDA")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "filterauto0_db_user")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'filterauto0_db_user')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Contact_to_dhanu_bot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Contact_to_dhanu_bot')
